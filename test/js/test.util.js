...
var util = require("../../js/index").util;
...
test("isPlainObject", function(t) {
  ...
  t.strictEqual(util.isPlainObject(new Dummy()),                     false);
  t.strictEqual(util.isPlainObject(Object.create(null)),             true);
  t.strictEqual(util.isPlainObject(Object.create(Array.prototype)),  false);
  t.strictEqual(util.isPlainObject(Object.create(RegExp.prototype)), false);
  t.strictEqual(util.isPlainObject(Object.create(Date.prototype)),   false);
  t.strictEqual(util.isPlainObject(Object.create(RegExp.prototype)), false);
  t.strictEqual(util.isPlainObject(Object.create(Dummy.prototype)),  false);
  t.strictEqual(util.isPlainObject(),                                false);
