...
var RequestQueue = require('../../js/request_queue').RequestQueue

test('RequestQueue', function(suite) {
  suite.test('should be empty', function(t) {
  ...
  suite.test('should succeed once', function(t) {
    t.plan(16);
    var counter = 0;
  ...
  suite.test('should fail once', function(t) {
    t.plan(15);
  ...
  suite.test('should raise on callback error', function(t) {
    t.plan(6);
  ...
  suite.test('should handle custom error on callback error', function(t) {
    t.plan(7);
  ...
  suite.test('should install global handle error on callback error', function(t) {
    t.plan(7);
